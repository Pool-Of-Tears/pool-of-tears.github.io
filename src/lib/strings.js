export const strings = {
  ...
  changelog: {
    title: "What's New",
    description: "Changelog of version",
  },
  // Pages
  HomePage: {
    title: "Pool of Tears",
    description:
      "Welcome to the Pool of Tears. We build apps and interesting stuff. A team of tech enthusiasts who are passionate about technology and its impact on our lives.",
